...
void main() {
  group('CountryFlag Widget Tests', () {
    testWidgets('Valid country code flag is displayed correctly', (WidgetTester tester) async {
    ...
    testWidgets('Invalid country code shows error message', (WidgetTester tester) async {
